...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        protected DOTweenAnimation _src;
...
#pragma warning restore 414
        ...
        override public void OnInspectorGUI()
        {
            ...
            #region cDevSoumen Added
            _src.AnimationMode = (DOTweenAnimation.EAnimationMode)EditorGUILayout.EnumPopup(_src.AnimationMode, GUILayout.Width(75));
            if (_src.AnimationMode.Equals(DOTweenAnimation.EAnimationMode.OnEntry) || _src.AnimationMode.Equals(DOTweenAnimation.EAnimationMode.OnExit))
            {
            ...
            else if (_src.AnimationMode.Equals(DOTweenAnimation.EAnimationMode.None) && _src.AllowResetId)
            {
            ...
            else
            {
                ...
                #region cDevSoumen Added
                if (_src.AnimationMode.Equals(DOTweenAnimation.EAnimationMode.None))
                    _src.id = EditorGUILayout.TextField("ID", _src.id);
                #endregion
