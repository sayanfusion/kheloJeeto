...
namespace DevCommon.GUI
{
    ...
    public class ScrollSnapEditor : Editor
    {
        ...
        private void AutomaticLayout()
        {
            ...
            if (scrollSnap.automaticallyLayout)
            {
                EditorGUI.indentLevel++;
                ...
                if (scrollSnap.sizeControl == ScrollSnap.SizeControl.Manual)
                {
                    EditorGUI.indentLevel++;
        ...
        private void InfiniteScrolling()
        {
            ...
            if (scrollSnap.infinitelyScroll)
            {
                EditorGUI.indentLevel++;
        ...
        private void AddTransitionEffect()
        {
            ...
            if (GUILayout.Button("Add Transition Effect"))
            {
                ...
                scrollSnap.transitionEffects.Add(new TransitionEffect(properties[selectedProperty], selectedMinValue, selectedMaxValue, selectedMinDisplacement, selectedMaxDisplacement, function, scrollSnap));
            }
