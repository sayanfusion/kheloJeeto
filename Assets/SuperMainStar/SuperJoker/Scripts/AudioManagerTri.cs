...
public class AudioManagerTri : MonoBehaviour
{
    public static AudioManagerTri Main
    {
        get
        {
            return Camera.main.GetComponent<AudioManagerTri>();
        }
    }
    ...
    /// Registers a sound with the AudioManagerTri and gives it an AudioSource if necessary
